...
public class HomePage {
  ...
  public String getTitleInList(Integer noteId) {
    ...
    wait.until(
        ExpectedConditions.textToBePresentInElementLocated(
            By.id("noteTitle of row " + noteId), "Testing"));
  ...
  public String getUrlInList(Integer credoId) throws InterruptedException {
    ...
    wait = new WebDriverWait(driver, 3, 10);
    wait.until(
        ExpectedConditions.textToBePresentInElementLocated(By.id("Url of row " + credoId), "www."));
  ...
  public void writeDescription(String desc) {
    ((JavascriptExecutor) driver)
        .executeScript("arguments[0].value='" + desc + "';", noteDescription);
  }
  ...
  public void editExistingCredential(
      String changedUrl, String changedUsername, String changedPassword, Integer credentialId) {
    accessCredentialTab();
  ...
  public void getCredentialForEditing(Integer credoId) {
    ...
    ((JavascriptExecutor) driver)
        .executeScript(
            "arguments[0].click();", credoTable.findElement(By.id("cedtbtn of row " + credoId)));
  }
  ...
  public void writeToCredential(String url, String username, String password) {
    ...
    ((JavascriptExecutor) driver)
        .executeScript("arguments[0].value='" + username + "';", credoUsername);
    ((JavascriptExecutor) driver)
        .executeScript("arguments[0].value='" + password + "';", credoPassword);
  }
  ...
  public void deleteExistingCredential(Integer credoId) {
    ...
    ((JavascriptExecutor) driver)
        .executeScript(
            "arguments[0].click();", credoTable.findElement(By.id("cdltbtn of row " + credoId)));
    ResultPage result = new ResultPage(driver);
    result.returnHomeAfterMessage();
    accessCredentialTab();
  }
  ...
  public boolean noteExists(String title) {
    List<WebElement> noteTitles =
        this.noteTable.findElements(By.xpath("//*[contains(@id, 'noteTitle of row')]"));
  ...
  public boolean credentialExists(String url) {
    List<WebElement> noteTitles =
        this.credoTable.findElements(By.xpath("//*[contains(@id, 'Url of row')]"));
    boolean exists = false;
    for (WebElement w : noteTitles) {
